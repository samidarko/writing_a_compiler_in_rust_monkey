...
fn benchmark_lexer(c: &mut Criterion) {
    ...
    group.bench_with_input(
        BenchmarkId::new("simple", "let_assignment"),
        &simple_code,
        |b, code| {
            b.iter(|| {
    ...
    group.bench_with_input(
        BenchmarkId::new("complex", "fibonacci_function"),
        &complex_code,
        |b, code| {
            b.iter(|| {
                let mut lexer = Lexer::new(black_box(code.chars().collect()));
    ...
    group.bench_with_input(
        BenchmarkId::new("array", "array_literal"),
        &array_code,
        |b, code| {
            b.iter(|| {
                let mut lexer = Lexer::new(black_box(code.chars().collect()));
    ...
    group.bench_with_input(
        BenchmarkId::new("hash", "hash_literal"),
        &hash_code,
        |b, code| {
            b.iter(|| {
                let mut lexer = Lexer::new(black_box(code.chars().collect()));
...
fn benchmark_parser(c: &mut Criterion) {
    ...
    group.bench_with_input(
        BenchmarkId::new("expression", "arithmetic_expression"),
        &expression_code,
        |b, code| {
            b.iter(|| {
                let lexer = Lexer::new(black_box(code.chars().collect()));
    ...
    group.bench_with_input(
        BenchmarkId::new("array", "complex_array"),
        &array_code,
        |b, code| {
            b.iter(|| {
                let lexer = Lexer::new(black_box(code.chars().collect()));
...
fn benchmark_evaluator(c: &mut Criterion) {
    ...
    group.bench_with_input(
        BenchmarkId::new("simple", "arithmetic"),
        &simple_code,
        |b, code| {
            b.iter(|| {
                let lexer = Lexer::new(black_box(code.chars().collect()));
    ...
    group.bench_with_input(
        BenchmarkId::new("fibonacci", "recursive_function"),
        &fibonacci_code,
        |b, code| {
            b.iter(|| {
                let lexer = Lexer::new(black_box(code.chars().collect()));
    ...
    group.bench_with_input(
        BenchmarkId::new("array", "array_operations"),
        &array_code,
        |b, code| {
            b.iter(|| {
                let lexer = Lexer::new(black_box(code.chars().collect()));
    ...
    group.bench_with_input(
        BenchmarkId::new("hash", "hash_operations"),
        &hash_code,
        |b, code| {
            b.iter(|| {
                let lexer = Lexer::new(black_box(code.chars().collect()));
...
fn benchmark_full_pipeline(c: &mut Criterion) {
    ...
    for (name, code) in programs {
        group.bench_with_input(
            BenchmarkId::new("lex_parse_eval", name),
            &code,
            |b, code| {
                b.iter(|| {
                    let lexer = Lexer::new(black_box(code.chars().collect()));
